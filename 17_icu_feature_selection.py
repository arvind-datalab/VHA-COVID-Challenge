...
car_df=car_df[(car_df['icu_flag'] == 1)]

df2= car_df.drop(['icu_date','inpatient_date','LOS_HOS','vent_date','covid_flag','PAYERBUCKET_NO COVERAGE',
                  'PAYERBUCKET_MED','PAYERBUCKET_HIGH','PAYERBUCKET_LOW',
                  'Cause of Death [US Standard Certificate of Death]',
                  'vent_flag','inpatient_flag','icu_flag','deceased_flag'],axis=1)
...
feat_imp.to_csv(output_path+'/variable_imp_icu.csv')
